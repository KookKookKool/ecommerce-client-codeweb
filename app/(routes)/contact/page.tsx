                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      <Container className="px-4">
                        ...
                        <p>
                          บริษัท โค้ดเว็บ จำกัด (สำนักงานใหญ่) <br/>
                          เลขนิติบุคคลเสียภาษี 0745567008485 <br/> 
                          ที่ตั้ง 69/9 หมู่ 3 ตำบลคอกกระบือ อำเภอเมือง จังหวัดสมุทรสาคร 74000 <br/>
                          Email : codeweb.service.th@gmail.com
                        </p>
                        <hr />
                      </Container>
                    </p>
